...
# CountGD Combined Evaluation Script for DICTA25
...
echo "🚀 Starting CountGD Combined Evaluation..."
...
# Other settings
MODEL_PATH="/home/khanhnguyen/DICTA25/CountGD/checkpoints"
MODEL_NAME="checkpoint_fsc147_best"
CONFIG_FILE="/home/khanhnguyen/DICTA25/CountGD/config/cfg_fsc147_vit_b.py"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help)
            ...
            echo "  --model_path PATH     Model path (default: /home/khanhnguyen/DICTA25/CountGD/checkpoints)"
            echo "  --config_file FILE    Config file (default: /home/khanhnguyen/DICTA25/CountGD/config/cfg_fsc147_vit_b.py)"
...
IMAGE_FOLDER="$DATA_PATH/images_384_VarV2"
...
OUTPUT_DIR="/home/khanhnguyen/DICTA25/CountGD/outputs"
mkdir -p "$OUTPUT_DIR"

echo "========================================" 
echo "Running CountGD Combined Evaluation"
echo "========================================"
echo "Model: CountGD Combined (2 positive + 1 negative exemplars + combined prompts)"
