...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help)
            ...
            echo "  --base_data_path P    Base path for dataset (default: ../../../DICTA25/final_dataset)"
...
mkdir -p "../../results/DAVE-qualitative/final_dataset"
mkdir -p "../../results/DAVE-quantitative/final_dataset"
...
if [ $? -eq 0 ]; then
    ...
    echo " Results saved to: ../../results/DAVE-qualitative/final_dataset/"
else
...
if [[ "$CREATE_VIS" =~ ^[Yy]$ ]]; then
    results_dir="../../results/DAVE-qualitative/final_dataset"
    ...
    echo "   Location: ../../results/DAVE-qualitative/final_dataset/visualizations/"
fi
