...
def save_quantitative_results(all_results, dataset_folder_name, model_name):
    ...
    quant_output_dir = "../../results/LearningToCountEverything-quantitative-combined"
...
def evaluate_combined(args):
    ...
    base_output_dir = "../../results/LearningToCountEverything-qualitative-combined"
    ...
    print(f"Quantitative results saved to: ../../results/LearningToCountEverything-quantitative-combined/{dataset_folder_name}/")
    print(f"\nFiles created:")
