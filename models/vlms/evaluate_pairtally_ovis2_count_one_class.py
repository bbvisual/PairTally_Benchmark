...
# Custom Dataset class for PairTally data (adapted for Ovis2-16B)
...
def get_args_parser():
    parser = argparse.ArgumentParser("PairTally Ovis2-16B Evaluation", add_help=False)
    ...
    parser.add_argument(
        ...
        default="./Ovis2_16B_PairTally_Results",
    )
    parser.add_argument(
        "--base_data_path",
...
def save_quantitative_results(all_results, dataset_folder_name, model_name):
    ...
    quant_output_dir = "../../results/Ovis2_16B-quantitative"
...
def main():
    parser = argparse.ArgumentParser("PairTally Ovis2-16B Evaluation", parents=[get_args_parser()])
    ...
    print("Ovis2-16B PairTally Evaluation")
    print("==============================")
    ...
    base_output_dir = "../../results/Ovis2_16B-qualitative"
    ...
    print(f"Quantitative results saved to: ../../results/Ovis2_16B-quantitative/{dataset_folder_name}/")
