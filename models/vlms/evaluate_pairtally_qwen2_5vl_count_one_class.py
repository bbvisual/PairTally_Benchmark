...
# Custom Dataset class for PairTally data (adapted for Qwen2.5-VL)
...
def get_args_parser():
    parser = argparse.ArgumentParser("PairTally Qwen2.5-VL Evaluation", add_help=False)
...
def save_quantitative_results(all_results, dataset_folder_name, model_name):
    ...
    quant_output_dir = "../../results/Qwen2_5VL-quantitative"
...
def main():
    parser = argparse.ArgumentParser("PairTally Qwen2.5-VL Evaluation", parents=[get_args_parser()])
    ...
    print("Qwen2.5-VL PairTally Evaluation")
    print("================================")
    ...
    base_output_dir = "../../results/Qwen2_5VL-qualitative"
    ...
    print(f"Quantitative results saved to: ../../results/Qwen2_5VL-quantitative/{dataset_folder_name}/")
