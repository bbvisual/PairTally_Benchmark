...
# Custom Dataset class for DICTA25 data (adapted for Ovis2 Combined)
...
def get_args_parser():
    parser = argparse.ArgumentParser("DICTA25 Ovis2 Combined Evaluation", add_help=False)
...
def save_quantitative_results(all_results, dataset_folder_name, model_name):
    ...
    quant_output_dir = "/home/khanhnguyen/DICTA25-RESULTS/Ovis2-combined-quantitative"
...
def main():
    parser = argparse.ArgumentParser("DICTA25 Ovis2 Combined Evaluation", parents=[get_args_parser()])
    ...
    print("Ovis2 DICTA25 Combined Evaluation")
    print("================================")
    ...
    qual_output_dir = "/home/khanhnguyen/DICTA25-RESULTS/Ovis2-combined-qualitative"
    ...
    print(f"Combined quantitative results saved to: /home/khanhnguyen/DICTA25-RESULTS/Ovis2-combined-quantitative/{dataset_folder_name}/")
