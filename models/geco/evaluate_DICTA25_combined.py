...
def save_quantitative_results(all_results, dataset_folder_name, model_name):
    ...
    quant_output_dir = "/home/khanhnguyen/DICTA25-RESULTS/GeCo-quantitative-combined"
...
def evaluate_combined(args):
    ...
    base_output_dir = "/home/khanhnguyen/DICTA25-RESULTS/GeCo-qualitative-combined"
    ...
    print(f"Quantitative results saved to: /home/khanhnguyen/DICTA25-RESULTS/GeCo-quantitative-combined/{dataset_folder_name}/")
    print(f"\nFiles created:")
